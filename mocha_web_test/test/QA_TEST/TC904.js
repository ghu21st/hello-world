...
//TC904: Test className-tagName-href click inside a div7
//QA test setup ----------------------------------------------
var case_ID = 904;
...
var nockOptions = {allowUnmocked: true};
    ...
    var ptor = null;
//-------------------------------------------------------
describe('TC904: Test className-tagName-href click inside div tag', function() {
...
//-------------------------------------------------------
    it('TC904: Test className-tagName-href click inside div tag', function(done) {
        //trace HTTP call
        nock.recorder.rec();
        ...
        async.series([
            ...
            function(callback){
                element1 = ptor.findElement(protractor.By.className('phones'))
                    .findElements(protractor.By.tagName('a')).then(function(links){
                        links[1].click();
                        //
                        callback(null, 4);
                    });
